...
export default function SelectedMap({ viewMode: _viewMode, onViewModeChange: _onViewModeChange }: SelectedMapProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {[
          { top: '27%', left: '35%', rotate: '-60deg' },
          { top: '42%', left: '27%', rotate: '-80deg' },
          { top: '31%', left: '56%', rotate: '0deg'   },
        ].map((s, i) => (
          <span
            key={i}
            className="absolute text-[8px] font-bold tracking-widest text-[#94A3B8] select-none pointer-events-none"
